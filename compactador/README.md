...
`preparacao-conquista-bff.db` é um snapshot completo do projeto
`preparacao-conquista-bff` (backend Spring Boot do BFF Conquista) empacotado
num único arquivo SQLite — todos os arquivos do projeto, exceto os
diretórios abaixo, cada um como uma linha da tabela `arquivos`.
...
```
python descompactar.py preparacao-conquista-bff.db ./preparacao-conquista-bff-restaurado
```
