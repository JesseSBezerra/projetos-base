...
`home-c2.db` é um snapshot completo do projeto `home-c2` (frontend Angular
da Home do Gerente de Conquista) empacotado num único arquivo SQLite —
todos os arquivos do projeto, exceto os diretórios abaixo, cada um como uma
linha da tabela `arquivos`.
...
```
python descompactar.py home-c2.db ./home-c2-restaurado
```
